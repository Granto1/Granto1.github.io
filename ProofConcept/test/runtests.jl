...
# !!! Main.UserApp is configured as an alias for Main.ProofConcept and you might encounter it in some tests
using Main.ProofConcept, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "ProofConcept tests" begin
  @includetests ARGS
end
